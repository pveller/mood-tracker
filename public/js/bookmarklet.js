  ...
  templates: {
    ...
    bookmarkletMarkup: [
      ...
      '<div id="{{k}}_bd">',
        ...
        '<iframe id="{{k}}_voteFrame" height="310" width="410" frameborder="0" style="overflow: hide; border: 1px green black;" scrolling="no" src="http://epam-mood.herokuapp.com/vote.html?personName={{personName}}" />',
        '</span>',
      '</div>'
    ].join('')
  }
